const words = ["men", "women", "child", "children", "neighbor", "student", "tree", "flower", "boat", "car", "airplane", "island", "country", "city", "desk"];
let word = words[Math.floor(Math.random() * words.length)];  //ova math random od 0.1 do 0.9 * dolzinata i dolniot broj, fo nema posledmiot dekako deka nizata pocnuva od nula
let Guesses = 5;
